...
public class ForkMain {
	...
	static class ForkSuiteSelector extends Selector implements Serializable {}
	static class ForkTestSelector extends Selector implements Serializable {
	...
	static class ForkNestedSuiteSelector extends Selector implements Serializable {
	...
	static class ForkNestedTestSelector extends Selector implements Serializable {
		private String suiteId;
		private String testName;
	...
	static class ForkEvent implements Event, Serializable {
		...
		public boolean isModule() { return isModule; }
		public Selector selector() { return forkSelector(selector); }
